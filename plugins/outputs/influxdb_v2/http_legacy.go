...
func (c *legacyHttpClient) Init() error {
...
func (c *legacyHttpClient) GetUrl() *url.URL {
	return c.url
}

type legacyGenericRespError struct {
	Code      string
	Message   string
	Line      *int32
	MaxLength *int32
...
func (g legacyGenericRespError) Error() string {
...
func (c *legacyHttpClient) Write(ctx context.Context, metrics []telegraf.Metric) error {
...
func (c *legacyHttpClient) splitAndWriteBatch(ctx context.Context, bucket string, metrics []telegraf.Metric) error {
...
func (c *legacyHttpClient) writeBatch(ctx context.Context, bucket string, metrics []telegraf.Metric) error {
	...
	writeResp := &legacyGenericRespError{}
...
func (c *legacyHttpClient) getRetryDuration(headers http.Header) time.Duration {
...
func (c *legacyHttpClient) addHeaders(req *http.Request) {
